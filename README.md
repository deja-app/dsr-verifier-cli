...
- **Audit the source.** Every line of verification logic is published at
  `github.com/deja-app/dsr-verifier-cli`. There is nothing to hide.
...
[GitHub Releases](https://github.com/deja-app/dsr-verifier-cli/releases). Each release includes
